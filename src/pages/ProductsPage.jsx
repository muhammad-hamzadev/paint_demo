              ...
              return (
                <div key={product.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl transition duration-300 flex flex-col group relative">
                  ...
                  <div className="p-6 flex flex-col flex-grow space-y-4">
                    ...
                    {/* Card Actions */}
                    <div className="product-card-actions flex items-center gap-2 pt-2">
                      <button
                        onClick={() => onSelectProduct(product)}
                        className="btn-card-secondary flex-1 bg-slate-100 hover:bg-slate-200 text-slate-800 font-extrabold text-xs py-2.5 px-3 rounded-xl transition flex items-center justify-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="btn-card-primary btn-whatsapp-icon-only shrink-0 bg-[#25D366] hover:bg-[#20ba5a] text-white font-extrabold text-xs py-2.5 px-3 rounded-xl shadow-md transition flex items-center justify-center"
                      >
